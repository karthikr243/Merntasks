...
function checkPasswordMatch() {
  ...
  var reEnterPassword = document.getElementById("repass").value;

  if (password !== reEnterPassword) {
    document.getElementById("repasspop").innerText = "MISMATCH";
    document.getElementById("repasspop").style.color = "red";
  } else {
    document.getElementById("repasspop").innerText = "Good";
    document.getElementById("repasspop").style.color = "green"; // Clear the error message if passwords match
  }
}

document.getElementById("pass").addEventListener("keyup", checkPasswordMatch);
document.getElementById("repass").addEventListener("keyup", checkPasswordMatch);
function checkage() {
